    ...
    <div className="container">
      <div className="row p-5">
        ...
        <div className="row mt-5 p-5 border-top">
          <div className="col-6 p-5 mt-3 fs-5">
            <p>
              ...
              word for barrier.
              <br></br><br></br>
               Today, our disruptive pricing models and
          ...
          <div className="col-6 mt-3 p-5 fs-5">
            <p>
              In addition, we run a number of popular open online educational
              and community initiatives to empower retail traders and investors.<br></br>
              <br></br>
